...
export default function Courses() {
  return (
    <section className="dark:bg-gbDark">
      <section className="mx-auto max-w-[1320px]  py-36">
        <div className="mx-auto mb-[60px] w-2/5 text-center">
          <h1 className="text-7xl font-semibold ">Course</h1>
          <p className="text-lg">
            Unlock your IT potential with bdCAlling today and embark on a
        ...
        <form className="relative mb-[75px] flex items-center">
          <input
            ...
            className="border-gbSky bg-gbDark w-full rounded-full border px-[30px] py-[18px] focus:outline-none"
          />
          <button
            type="submit"
        ...
        <div className="flex flex-col gap-6 md:flex-row">
          ...
          <div>
            <div className=" grid grid-cols-1 gap-6 md:grid-cols-2 p-5">
              <CourseCart />
              <CourseCart />
              <CourseCart />
            </div>
            <button className="col-span-2 mt-10 mx-auto rounded-md bg-sky-500 px-[30px] py-[16px]">
              See More
            </button>
          </div>
        </div>
